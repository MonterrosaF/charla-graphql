...
import GetViewer from "../src/graphql/GetViewer.gql";
import GetUser from "../src/graphql/GetUser.gql";
...
const createGithubUser = (
  { login, avatarUrl, contributionsCollection },
  userElement,
  doMojo = false
) => {
...
const createRepositories = (repositories) => {
  NODES.list.innerHTML = repositories
    .map(
