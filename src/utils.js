...
export const createMojo = (constributionsCollection) =>
  Object.values(constributionsCollection).filter((valor)=> typeof valor === 'number' && !Number.isNaN(valor)).reduce((acc, current) => (acc + current), 0);
